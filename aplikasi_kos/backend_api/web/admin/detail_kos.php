...
<div class="main-content">
    <div class="container-fluid">
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h3 class="fw-bold mb-0">Detail Kos</h3>
                <p class="text-muted mb-0">Informasi lengkap detail kos milik <strong><?= htmlspecialchars($data['nama_pemilik'] ?? 'Pemilik') ?></strong></p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="sticky-price">
                    <div class="price-card">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="#" class="btn btn-outline-primary py-3 rounded-pill fw-bold disabled" style="pointer-events: none; opacity: 0.6;">
