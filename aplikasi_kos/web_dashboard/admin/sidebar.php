<div class="sidebar p-3">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link mb-2 <?= ($current_page == 'manajemen_akun.php') ? 'active' : '' ?>" href="manajemen_akun.php">
        ...
        <a class="nav-link mb-2 <?= ($current_page == 'blog.php') ? 'active' : '' ?>" href="blog.php">
            <i class="bi bi-card-text me-2"></i> Kelola Blog
        </a>

        <a class="nav-link mb-2 <?= ($current_page == 'daftar_blog.php') ? 'active' : '' ?>" href="daftar_blog.php">
            <i class="bi bi-journal-text me-2"></i> Daftar Blog
        </a>
